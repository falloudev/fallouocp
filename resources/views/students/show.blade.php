        ...
        <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="http://groupetrust.com/" target="_blank" class="logo"><img style="width:170px"  src="{{asset('assets/images/logo-Groupe-Trust.png')}}"> </a>
                </div>
            </div>
                    ...
                    <div class="row" >
                        <div class="col-md-12" >
                            <div class="panel panel-default">
                                ...
                                <tr>
                                    <td><b><img src="{{url('images',$student->file) }}" style="width:980px;"></b></td>
