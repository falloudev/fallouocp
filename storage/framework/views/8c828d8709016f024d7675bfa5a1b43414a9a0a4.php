    ...
    <div id="wrapper">
        ...
        <div class="content-page" style="margin-left:15px; margin-top:-100px;">
            ...
            <tr>
                ...
                <td><a href="<?php echo e(route('participant.show', $student->id)); ?>"><b><?php echo $student->prenom; ?></b></a></td>
                ...
                <td><a href="<?php echo e(route('participant.show', $student->id)); ?>"><b><?php echo $student->file; ?></a></b></td>
